% yy(varargin) :  mimics the dipimage yy function. See its documentation.
...
%**************************************************************************
%
function res=yy(varargin)
global use_xyz_cuda;
global diphandle_yy;
if (use_xyz_cuda)
    tmp=cuda(1.0);
    res= yy_cuda2(tmp,varargin{:});
else
    res=feval(diphandle_yy,varargin{:});  % call the standart matlab zeros function
    %res=yy(varargin{:});  % call the standart matlab zeros function
end
