% phiphi_cuda2(in,varargin) :  mimics the dipimage phiphi function in cuda. See the dipimage function for documentation.
...
%**************************************************************************
%
function out=phiphi_cuda2(in,varargin)
    pos1=1;
    mysize=[];
    ...
    out.ref=cuda_cuda('phiphi',mysize,startVec,endVec);
    out.fromDip=1;
end
