% ifftn_part(in,transformDirs) : n-dimensional inverse Fourier transform with a boolean vector of transform directions
% see also: 
...
if isa(in,'cuda') 
    if in.fromDip
        error('ifftn_part: Not used for datatype DipImage. Use ft or dip_fouriertransform instead!');
    end
    insize=size(in);
