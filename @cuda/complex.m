% complex(in1,in2) : constructs a complex cuda array from real and imaginary arrays
...
%         error('cuda:complex of Matlab array type: Matrix dimensions must agree.')
%     end
    ...
    out.ref=cuda_cuda('complex',in1.ref,in2.ref);
