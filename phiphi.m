% phiphi(varargin) :  mimics the dipimage phiphi function. See its documentation.
...
%**************************************************************************
%
function res=phiphi(varargin)
global use_xyz_cuda;
global diphandle_phiphi;
if (use_xyz_cuda)
    tmp=cuda(1.0);
    res= phiphi_cuda2(tmp,varargin{:});
else
    res=feval(diphandle_phiphi,varargin{:});  % call the standart matlab zeros function
end
