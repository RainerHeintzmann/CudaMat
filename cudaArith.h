...
#define CUDA_MAXDIM 7   // is needed for transferring parameters, CAREFUL! This uses for some function this number of variables on each processor
#define CUDA_MAXPROJ 7  // needed for projections
