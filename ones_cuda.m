% ones_cuda : overloaded function from the cudaMat package. 
...
function res=ones_cuda(varargin)
global use_ones_cuda;
if (use_ones_cuda)
    tmp=cuda(1.0);
    res= ones_cuda2(tmp,varargin{:});        
else
    res=builtin('ones',varargin{:});  % call the standart matlab zeros function
end
