% ones : overloaded function from the cudaMat package. 
...
if (use_ones_cuda)
    tmp=cuda(1.0);
    [varargout{1:nargout}] = ones_cuda2(tmp,varargin{:});        
else
    [varargout{1:nargout}] =builtin('ones',varargin{:});  % call the standart matlab zeros function
end
