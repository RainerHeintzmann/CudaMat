% power(in1, in2) : takes one array elementwise to the power of the second parameter or array
...
%     end
    ...
    out.ref=cuda_cuda('power',in2.ref,in1.ref);
